			...
			<div class="carousel-inner">
		      <?php
				...
				<div class="item <?php echo ($x == 0 ? 'active' : ''); ?>">
		          <img src="<?php echo ($slide['image'] == '' ? 'images/no-image' : $slide['image']); ?>" width="100%" style="height: 350px;">
        ...
        <div class="col-sm-4 col-md-4" style="margin-bottom: 20px">
            <div class="post">
                <div class="post-img-content">
                    <img src="<?php echo ($sec['image'] == '' ? 'images/no-image' : $sec['image']);?>" class="img-responsive" style="width: 100%;height: 200px;"/>
					...
					$tab_1 = mysqli_query($conn , "SELECT * FROM `posts` WHERE `status` = 'published' AND `category` = '$setting[tab_a]' ORDER BY `post_id` DESC LIMIT $setting[tab_a_value]");
						...
						?>
							<div class="bg_tab_topic">
								<div class="col-md-3">
										<img src="<?php echo ($tab_a['image'] == '' ? 'images/no-image' : $tab_a['image']);?>" width="100%" height="150px" class="img-thumbnail" />
									</div>
									<div class="col-md-9">
		...
		<!-- start category B -->
			...
			?>
				...
				<div class="bg_tab_topic col-md-6">
					<div class="col-md-4">
						<img src="<?php echo ($sec2['image'] == '' ? 'images/no-image' : $sec2['image']);?>" width="100%" class="circle" />
					</div>
					<div class="col-md-8">
