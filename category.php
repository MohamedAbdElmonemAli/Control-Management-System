...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo $id; ?></li>
    ...
    <div class="col-lg-12 art_bg">
      ...
      <div class="cate-post">
        <div class="col-md-3 ">
        <img src="<?php echo ($post['image'] == '' ? 'images/no-image' :$post['image']); ?>" width="100%" />
        </div>
          <div class="col-md-9 ">
          ...
          <p>
            ...
            <a href="post.php?id=<?php echo $post['post_id']; ?>" class="btn btn-warning pull-left">اقرا المزيد </a>
            <p class="pull-right"><i class="fas fa-user"></i> : <a href="profile.php?user=<?php echo $post['user_id']; ?>"><?php echo $post['username']; ?> </a>  |  <i class="fas fa-clock"></i> <?php echo $post['post_date']; ?></p>
            </div>
        ...
        <nav class="text-center">
          <ul class="pagination">
            ...
            for ($i=1; $i <=$total_page ; $i++) {
              echo '<li '.($page == $i ? 'class="active"' :'').'><a href="category.php?cate='.$id.'&page='.$i.'">'.$i.'</a></i>';
            }
            ?>
          </ul>
        </nav>
