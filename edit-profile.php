	...
	<div class="col-lg-12 art_bg">
			...
			<input type="hidden" value="<?php echo $user['user_id']; ?>" name="user" />
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <textarea class="form-control" name="about" id="about-you" rows="4"><?php echo strip_tags($user['about-you']); ?></textarea>
				</div>
			  </div>
			<div class="form-group">
				<label for="facebook" class="col-sm-2 control-label "><i class="fab fa-facebook fa-lg lo_face"></i></label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="twitter" class="col-sm-2 control-label "><i class="fab fa-twitter-square fa-lg lo_twit"></i></label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="instagram" class="col-sm-2 control-label "><i class="fab fa-instagram fa-lg lo_inst"></i></label>
				<div class="col-sm-9">
				  <input type="text" class="form-control" name="instagram" value="<?php echo $user['instagram']; ?>" id="instagram" placeholder="ادخل رابط صغحتك علي انستجرام">
				</div>
			  </div>
			  <div id="up_result" style="margin: 20px 0; " ></div>
			  <div class="form-group">
