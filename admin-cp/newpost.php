	...
	<div class="row">
		...
		<?php echo $msg; ?>
			<div class="panel panel-info">
		      <div class="panel-heading"><b>إضافة مقال جديد</b></div>
		      <div class="panel-body">
						<form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="form-group">
								<label for="title" class="col-sm-2 control-label">عنوان المقال :</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" value="<?php echo $title; ?>" name="title" id="title" placeholder="أدخل عنوان المقال">
								</div>
							</div>
							<div class="form-group">
